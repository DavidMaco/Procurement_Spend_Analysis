...
description: Use when reviewing proposed or completed changes for compliance with repository standards, quality gates, security rules, and documentation requirements. Trigger for audits, pre-merge checks, and post-change compliance validation.
---
...
3. Python application and data processing standards
4. Security checklist, applying only items relevant to the artifact under review
5. Frontend quality and Streamlit standards
...
- Mark security items as N/A when they do not apply to the artifact.
